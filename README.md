...
N1 є українскьою трансформерною кодовою архітектурою. Вперше була навчена на задачі сумаризації українського тексту. Після цього, вона добре себе показала на задачі машинного перекладу с української мови на англійську. Розроблена [Анаром Лавреновим, Head of AI компанії SPUNCH](https://www.linkedin.com/mynetwork/). N1 має на меті заохотити вітчизняних Дата Сайнтистів до розвитку українскього напряму ШІ. 
...
Англ: I can be serious and funny
```
